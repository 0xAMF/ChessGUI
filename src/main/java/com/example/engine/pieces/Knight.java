...
public final class Knight extends Piece {
    ...
    public ImageView getPieceIcon() throws FileNotFoundException {
        if (this.getPieceColor() == PieceColor.BLACK) {
            Image blackKnight = new Image(new FileInputStream("PieceIcon/blackKnight.png"));
            return new ImageView(blackKnight);
        }
        else {
            Image whiteKnight = new Image(new FileInputStream("PieceIcon/whiteKnight.png"));
            return new ImageView(whiteKnight);
        }
    }
